...
my $ftp_script_pl = "$script_path/snpeff_filter_script.pl";
...
print $fh_sh "perl $script_path/snpeff_filter_script.pl -i $input_path -o $output_path -c $config_file -s $sample\n"; 
